  ...
  return (
    <div className="min-h-[90vh] flex items-center justify-center bg-white">
      <div className="p-6 bg-gray-100 rounded-lg shadow-md max-w-lg w-full">
        <h1 className="text-2xl font-semibold text-center mb-4">User Information</h1>
        <p className="text-xl font-medium text-gray-700 text-center">This page is only accessible to admin users</p>
        <div className="mt-4">
